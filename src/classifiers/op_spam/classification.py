...
def logistic_regression(X, Y, test_fraction=0.25):
    ...
    op_spam.train_classifier_and_evaluate_accuracy_on_training_data(classifier, X_train, Y_train)
    op_spam.train_classifier_and_evaluate_accuracy_on_testing_data(classifier, X_test, Y_test)
